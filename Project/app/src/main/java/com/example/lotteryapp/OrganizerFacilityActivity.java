...
public class OrganizerFacilityActivity extends AppCompatActivity {
    ...
    private boolean isOrganizer; // Determine if the current user is an organizer
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (isEditing) {
            ...
            removeButton.setVisibility(isOrganizer ? View.VISIBLE : View.GONE); // Show remove button only for organizers
        } else {
            facility = new Facility();
            removeButton.setVisibility(View.GONE); // Hide remove button for new facility creation
        }
